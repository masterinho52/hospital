...
class Test_controller extends CI_Controller {
	...
	function test() {
		try{
			...
			//$crud->required_fields('nombre_prueba', 'apellido_prueba');
			$crud->set_rules('nombre_prueba','Nombre del Cliente','alpha_space');
			$crud->set_rules('apellido_prueba','Apellido del Cliente','alpha_space');
			// $crud->columns('nombre_prueba');
			// ^(\([0][1-4][0-9]{2}\)[0-9]{7})+$
			$output = $crud->render();
